    ...
    async (date) => {
      ...
      try {
        ...
        const res = await axios.get(
          `${API_BASE}/availability/${service.provider_id}/${dateStr}`
        );
    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        <div className="modal-header">
          <h3>
            Book: <span className="highlight">{service.service_name}</span>
          </h3>
        ...
        <div className="booking-body">
          <div className="calendar-section">
            <h4>
              <CalendarIcon /> Select a Date
            </h4>
            <div className="week-navigator">
              <button onClick={prevWeek} disabled={isPrevWeekDisabled}>
                <ChevronLeftIcon />
              </button>
          ...
          <div className="slots-section">
            <h4>
              <ClockIcon /> Available on {format(selectedDate, "MMMM d")}
            </h4>
