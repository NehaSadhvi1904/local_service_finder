        ...
        <div className="booking-card-footer">
          {booking.review_id ? (
            <div className="review-display">
              <h4>
                {user?.role === "Customer" ? "Your Review" : "Customer Review"}:
              </h4>
            ...
            user?.role === "Customer" && (
              <button
                ...
                onClick={() => onRateAndReview(booking)}
              >
                Rate & Review
              </button>
            )
  ...
  const upcomingBookings = useMemo(
    () =>
      bookings
        ...
        .sort(
          (a, b) =>
            new Date(a.booking_start_time) - new Date(b.booking_start_time)
        ),
    [bookings]
  );
  ...
  const pastBookings = useMemo(
    () =>
      bookings
        ...
        .sort(
          (a, b) =>
            new Date(b.booking_start_time) - new Date(a.booking_start_time)
        ),
    [bookings]
  );
  ...
  const renderBookingsList = (list) => {
    ...
    return list.map((booking) => (
      <BookingCard
        ...
        booking={booking}
        user={user}
        onRateAndReview={handleOpenRatingModal}
      />
    ));
  };
