        ...
        <div className="hero-content container">
          <div className="hero-text">
            <h1 className="hero-heading">
              Find & Book{" "}
              <span className="gradient-text">Trusted Local Services</span> In
              Minutes
            </h1>
          ...
          <div className="hero-image-pane">
            <div className="hero-graphic">
              ...
              <div className="graphic-icon icon-1" style={{ "--i": 1 }}>
                <Wrench size={24} />
              </div>
              <div className="graphic-icon icon-2" style={{ "--i": 2 }}>
                <Paintbrush size={24} />
              </div>
              <div className="graphic-icon icon-3" style={{ "--i": 3 }}>
                <Hammer size={24} />
              </div>
              <div className="graphic-icon icon-4" style={{ "--i": 4 }}>
                <HomeIcon size={24} />
              </div>
              <div className="graphic-icon icon-5" style={{ "--i": 5 }}>
                <Utensils size={24} />
              </div>
              <div className="graphic-icon icon-6" style={{ "--i": 6 }}>
                <Briefcase size={24} />
              </div>
            </div>
          </div>
          ...
          <div className="cta-card">
            <div className="cta-content">
              ...
              <p className="cta-subtitle">
                Are you a customer looking for help or a provider looking to
                grow your business? Join us today!
              </p>
              <div className="hero-cta-group">
                ...
                >
                  <Search size={20} /> Find Services Now
                </button>
                <button
