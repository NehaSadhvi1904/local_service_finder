  ...
  return (
    <div className="star-rating">
      ...
      <span className="rating-text">
        {parseFloat(rating).toFixed(1)} ({count}{" "}
...
const CustomerDashboard = () => {
  ...
  const getAvailabilityClass = (availability) =>
    availability?.toLowerCase().replace(/\s+/g, "-") || "unavailable";
    ...
    <div className="customer-dashboard">
      ...
      <main className="customer-content-area">
        <div className="content-header">
          ...
          <p>
            Get top-quality service from our verified and trusted providers.
          </p>
        </div>
                ...
                >
                  <div className="card-img-container">
                    <img
                      src={
                        s.image_url ||
                        `https://placehold.co/400x250/10101a/a99eff?text=${s.service_name
                          .split(" ")
                          .map((w) => w[0])
                          .join("")}`
                      }
                  ...
                  <div className="card-content">
                    ...
                    <div className="card-meta">
                      <span>
                        <UserIcon /> {s.provider_name || "Anonymous"}
                      </span>
                      <span>
                        <MapPinIcon /> {s.location || "Not specified"}
                      </span>
                    </div>
                  </div>
                </div>
